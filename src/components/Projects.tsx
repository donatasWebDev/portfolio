        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="md:col-span-2 group relative rounded-2xl bg-zinc-900 border border-zinc-800 overflow-hidden hover:border-zinc-700 transition-colors">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              <div className="h-64 lg:h-auto bg-zinc-800 relative overflow-hidden">
                ...
                <img src="https://images.unsplash.com/photo-1614726365723-49cfae9278b7?w=800&q=80" alt="NovelVerse Interface" className="w-full h-full object-cover opacity-60 group-hover:opacity-80 transition-opacity duration-500" />
              </div>
              ...
              <div className="p-8 lg:p-10 flex flex-col justify-center relative z-20">
                ...
                <p className="text-zinc-400 mb-6 leading-relaxed">
                  ...
                  sockets, smart buffering for seamless 15x playback, GPU
                  queuing, and a private auth system with a React playlist
                  interface.
                </p>

                <div className="flex flex-wrap gap-2 mb-8">
                  {['React', 'Node.js', 'Python', 'WebSockets', 'TTS Pipeline'].map(tag => <span key={tag} className="text-xs font-mono text-zinc-500 bg-zinc-950 px-2 py-1 rounded">
                      {tag}
                    </span>)}
                </div>
